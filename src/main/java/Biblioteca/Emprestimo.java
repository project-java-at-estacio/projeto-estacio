...
public class Emprestimo {
    ...
    public Emprestimo[] adicionaEmprestimo(Emprestimo[] emps, Emprestimo emp){
        ...
        //gravar no arquivo
        this.gravaEmprestimos("data/emprestimos.txt", emp);//vamos ter tudo no arquivo
    ...
    public void realizarEmprestimo(Emprestimo[] emprestimos, Livro[] livros, Leitor[] leitores,Fila[] filas){
        ...
        if(empTeste.getIdLeitor()!=0){
            ...
            if(confirma.equals("s")){
                ...
                fi.gravaFilas("data/fila.txt", fi);
            }
            ...
            if(confirma.equals("s")){
                ...
                gravaEmprestimos("data/emprestimos.txt", emp);//vamos ter tudo no arquivo
            }
            //teclado.close();
        }
    ...
    public void devolverLivro(Emprestimo[] emprestimos, Livro[] livros, Leitor[] leitores,Fila[] filas){
        ...
        if(confirma.equals("s")){
            ...
            atualizaEmprestimos("data/emprestimos.txt", emprestimos, emprestimo);
        ...
        if(tem.length>0){
            ...
            fila.removeDaFila("data/fila.txt",filas,idLivro,tem[0]);
